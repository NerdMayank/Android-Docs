...
public class MainActivity extends AppCompatActivity {
    ...
    Class c[] = {MyList.class,MyGrid.class,MyWeb.class,MyOption.class,MyContext.class,MyIntent.class,MyEmail.class,MyCheck.class,MyRadio.class,MyRating.class,MySpinner.class,MyAlert.class,MyAuto.class,MySearch.class} ;
    @Override
